...
ESPSection:addToggle("Remove Camera Shake", false, function(toggle))

ESPSection:addToggle("No Spread", false, function(toggle))

ESPSection:addToggle("No bloom", false, function(toggle))
